...
SERVICE_CAPS = kb_cufflinks
SPEC_FILE = kb_cufflinks.spec
URL = https://kbase.us/services/kb_cufflinks
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
build-test-script:
	...
	echo 'cp -R /kb/module/lib/kb_cufflinks/ /kb/module/work/kb/module/lib/' >> $(TEST_DIR)/$(TEST_SCRIPT_NAME)

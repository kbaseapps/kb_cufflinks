...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_cufflinks'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_cufflinks.kb_cufflinksImpl import kb_cufflinks  # noqa @IgnorePep8
impl_kb_cufflinks = kb_cufflinks(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_cufflinks'
        ...
        self.rpc_service.add(impl_kb_cufflinks.run_cufflinks,
                             name='kb_cufflinks.run_cufflinks',
                             types=[dict])
        self.method_authentication['kb_cufflinks.run_cufflinks'] = 'required'  # noqa

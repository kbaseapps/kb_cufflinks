...
public class KbCufflinksClient {
     ...
     * <pre>
     * </pre>
     * @param   params   instance of type {@link us.kbase.kbcufflinks.CuffdiffInput CuffdiffInput}
     * @return   parameter "returnVal" of type {@link us.kbase.kbcufflinks.CuffdiffResult CuffdiffResult}
     * @throws IOException if an IO exception occurs
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public CuffdiffResult runCuffdiff(CuffdiffInput params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
        TypeReference<List<CuffdiffResult>> retType = new TypeReference<List<CuffdiffResult>>() {};
        List<CuffdiffResult> res = caller.jsonrpcCall("kb_cufflinks.run_Cuffdiff", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("kb_cufflinks.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}

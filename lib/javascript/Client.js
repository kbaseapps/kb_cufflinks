...
function kb_cufflinks(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    this._check_job = function (job_id, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_cufflinks._check_job", 
            [job_id], 1, _callback, _errorCallback);
    };

    this.CufflinksCall = function (params, _callback, _errorCallback, json_rpc_context) {
        ...
        self._CufflinksCall_submit(params, function(job_id) {
    ...
    this._CufflinksCall_submit = function (params, _callback, _errorCallback, json_rpc_context) {
        ...
        return json_call_ajax(_url, "kb_cufflinks._CufflinksCall_submit", 
            [params], 1, _callback, _errorCallback, json_rpc_context);
    };
    
 
    this.run_Cuffdiff = function (params, _callback, _errorCallback, json_rpc_context) {
        if (self.service_version) {
            if (!json_rpc_context)
                json_rpc_context = {};
            json_rpc_context['service_ver'] = self.service_version;
        ...
        var async_job_check_time_ms = self.async_job_check_time_ms;
        self._run_Cuffdiff_submit(params, function(job_id) {
            var _checkCallback = null;
            _checkCallback = function(job_state) {
                if (job_state.finished != 0) {
                    if (!job_state.hasOwnProperty('result'))
    ...
    this._run_Cuffdiff_submit = function (params, _callback, _errorCallback, json_rpc_context) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "kb_cufflinks._run_Cuffdiff_submit", 
            [params], 1, _callback, _errorCallback, json_rpc_context);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_cufflinks.status",

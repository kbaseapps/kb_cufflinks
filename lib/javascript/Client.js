...
function kb_cufflinks(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    this.run_cufflinks = function (params, _callback, _errorCallback, json_rpc_context) {
        ...
        self._run_cufflinks_submit(params, function(job_id) {
    ...
    this._run_cufflinks_submit = function (params, _callback, _errorCallback, json_rpc_context) {
        ...
        return json_call_ajax(_url, "kb_cufflinks._run_cufflinks_submit", 
